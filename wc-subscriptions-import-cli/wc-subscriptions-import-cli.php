<?php
/*
Plugin Name: WooCommerce Subscriptions Importer with WP-CLI
Description: Easily import WooCommerce subscriptions across your WordPress multisite network using WP-CLI. This plugin simplifies the management of WooCommerce subscription data, supporting seamless migration and bulk import of subscriptions with just a few CLI commands. Perfect for large eCommerce stores and networks, this tool is optimized for performance and multisite compatibility, helping you efficiently manage multiple stores from one central dashboard.
Version: 1.1.3
